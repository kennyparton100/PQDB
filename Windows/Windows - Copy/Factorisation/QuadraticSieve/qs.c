...
/**
 * Tonelli-Shanks style modular square root helper for odd factor-base primes.
 * Returns 0 when `n` is not a quadratic residue modulo `p`.
 */
...
/**
 * U128 QS entry point.
 * Delegates to the uint64 engine for narrow values and otherwise promotes the
 * input to the bounded BigNum QS implementation.
 */
